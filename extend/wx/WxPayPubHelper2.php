...
class Redpack_pub extends Wxpay_client_pub
{
	...
	function createXml()
	{
		try
		{
			...
			return  $this->getXml($this->parameters);
		}catch (SDKRuntimeException $e)
		{
			die($e->errorMessage());
		}
	...
	function getXml($parameters){
            $sb = "<xml>";
			$sb .= "<act_name><![CDATA[".$parameters['act_name']."]]></act_name>";
			$sb .= "<client_ip><![CDATA[".$parameters['client_ip']."]]></client_ip>";

			$sb .= "<mch_billno>".$parameters['mch_billno']."</mch_billno>";
			$sb .= "<mch_id>".$parameters['mch_id']."</mch_id>";

        	$sb .= "<nonce_str><![CDATA[".$parameters['nonce_str']."]]></nonce_str>";
        	$sb .= "<re_openid><![CDATA[".$parameters['re_openid']."]]></re_openid>";

        	$sb .= "<remark><![CDATA[".$parameters['remark']."]]></remark>";
		    $sb .= "<send_name><![CDATA[".$parameters['send_name']."]]></send_name>";
			$sb .= "<total_amount>".$parameters['total_amount']."</total_amount>";
			$sb .= "<total_num>".$parameters['total_num']."</total_num>";
        	$sb .= "<wishing><![CDATA[".$parameters['wishing']."]]></wishing>";

        	$sb .= "<wxappid><![CDATA[".$parameters['wxappid']."]]></wxappid>";
        	$sb .= "<sign><![CDATA[".$parameters['sign']."]]></sign>";
			$sb .= "</xml>";
			return $sb;
	}
