<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\wamp\www\htt\public/../application/admin\view\product\edit.html";i:1520308481;s:67:"F:\wamp\www\htt\public/../application/admin\view\common\common.html";i:1520393002;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <form action="" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" id="name" value="<?php echo $data['price']; ?>" name="price"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
