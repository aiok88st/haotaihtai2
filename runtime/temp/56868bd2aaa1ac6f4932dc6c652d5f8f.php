<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\wamp\www\htt\public/../application/admin2\view\mark\create.html";i:1521014552;s:68:"F:\wamp\www\htt\public/../application/admin2\view\common\common.html";i:1520393002;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <form action="" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text"  name="needIntegral"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="limit_buy" value="1"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-input-block">
                    <div class="layui-upload">
                        ...
                        <div class="layui-upload-list" style="margin: 10px 12px;">
                            <img class="layui-upload-img" id="cltLogo" width="100px">
                            <p id="demoText"></p>
                        </div>
                    </div>
                </div>
