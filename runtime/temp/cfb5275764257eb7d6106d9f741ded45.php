<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\wamp\www\htt\public/../application/admin2\view\..\..\common\view\from\index.html";i:1520391764;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    <form action="<?php echo $addAction; ?>" method="post" class="layui-form layui-form-pane">
        ...
        <?php if(is_array($from) || $from instanceof \think\Collection): $i = 0; $__LIST__ = $from;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
