<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\wamp\www\htt\public/../application/admin2\view\index\index.html";i:1520391762;s:68:"F:\wamp\www\htt\public/../application/admin2\view\common\common.html";i:1520393002;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="<?php echo url('index/index'); ?>">好太太后台管理系统</a></div>
        <div class="left_open">
            ...
            <ul id="nav">
                <?php if(is_array($menu_list) || $menu_list instanceof \think\Collection): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li>
                        ...
                        <ul class="sub-menu">
                            <?php if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <li>
