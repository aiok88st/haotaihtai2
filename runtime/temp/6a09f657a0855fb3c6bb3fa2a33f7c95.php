<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\wamp\www\htt\public/../application/admin2\view\mark\index.html";i:1520413891;s:68:"F:\wamp\www\htt\public/../application/admin2\view\common\common.html";i:1520393002;s:65:"F:\wamp\www\htt\public/../application/admin2\view\common\nav.html";i:1520391761;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <div class="layui-row">
            <form method="get" action="<?php echo url('Mark/index'); ?>" class="layui-form layui-col-md12 x-so">
                <div class="layui-input-inline">
                    <input type="text" name="key" value="<?php echo $sreach['key']; ?>" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
                </div>
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('添加积分商品','<?php echo url('Mark/create'); ?>')"><i class="layui-icon"></i>添加</button>
        ...
        <table class="layui-table">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><?php echo $vo['needIntegral']; ?></td>
                    <td><?php echo $vo['number']; ?></td>
                    <td><?php echo $vo['limit_buy']; ?></td>
                    <td><?php echo date("Y-m-d H:i:s",$vo['add_time']); ?></td>
                    <td class="td-manage" >
                        <a title="编辑"  onclick="x_admin_show('编辑积分商品','<?php echo url('Mark/edit',['id'=>$vo['id']]); ?>')" href="javascript:;">
                            编辑
                        </a>
    ...
    <script type="text/javascript">
        ...
        function delAll(argument) {
            ...
            layer.confirm('确认删除这条数据？',function(index){
                //捉到所有被选中的，发异步进行删除
                //捉到所有被选中的，发异步进行删除
                var url="<?php echo url('Mark/delete'); ?>";
