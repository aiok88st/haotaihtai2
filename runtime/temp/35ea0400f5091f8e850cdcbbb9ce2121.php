<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\wamp\www\htt\public/../application/admin2\view\menu\index.html";i:1520391762;s:68:"F:\wamp\www\htt\public/../application/admin2\view\common\common.html";i:1520393002;s:65:"F:\wamp\www\htt\public/../application/admin2\view\common\nav.html";i:1520391761;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        ...
        <table class="layui-table">
            ...
            <tbody>
                <?php if($list): if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <?php if(!(empty($vo['route']) || ($vo['route'] instanceof \think\Collection && $vo['route']->isEmpty()))): ?>
                    ...
                    <?php if($vo['child']): if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <?php if(!(empty($v['route']) || ($v['route'] instanceof \think\Collection && $v['route']->isEmpty()))): ?>
