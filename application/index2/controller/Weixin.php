...
{
    protected $appid="wxb51ec89c4b705bf0";
    protected $appsecret="468740fa8038ca91df82ef648466eb60";
...
//    protected $appsecret="e08938754b2cc199627f424b17c5bf25";
    ...
    public function index() {
        ...
        $redirect_uri = urlencode('https://'.$_SERVER['HTTP_HOST'].__ROOT__.'/listing.php/index2/Weixin/oauth');
