...
layui.use(['element'], function(){
  ...
  // 侧边栏点击隐藏兄弟元素
	$('.layui-nav-item > a').click(function(event) {
		$(this).parent().siblings().removeClass('layui-nav-itemed').find(".layui-nav-child").slideUp("fast");
        $(this).parent().find(".layui-nav-child").slideToggle("fast");
	});
